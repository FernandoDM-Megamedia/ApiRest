import { CharacterEntityApiRM } from './character-collectionRM.api-model';

// prueba de los 20 primeros para ver como se comporta

export const mockCharacterCollectionRM: CharacterEntityApiRM[] = [
  {
    id: 1,
    name: 'Rick Sanchez',
    status: 'Alive',
